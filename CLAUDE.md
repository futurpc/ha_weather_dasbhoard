...
src/
  ...
  config.h            - WiFi creds, HA URL/token, entity IDs, display dimensions
  ...
  ui.h/.cpp           - LVGL 8 UI layout + update functions + F/C toggle
...
### UI (ui.cpp)
- Dark theme: BG=0x0D1117, Card=0x21262D
- Status bar (36px): WiFi icon, status, "Home Weather" title, F/C toggle button, "Updated: HH:MM"
